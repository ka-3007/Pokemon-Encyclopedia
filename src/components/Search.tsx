    ...
    <div className="py-2">
      <div className="w-full max-w-4xl mx-auto p-4">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mb-8">
          ...
          <button
            onClick={onSearch}
            className="w-full sm:w-auto px-4 py-2 mb-2 sm:mb-0 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 border"
          >
            検索
          </button>
          <button
            onClick={onReset}
            className="w-full sm:w-auto px-4 py-2 bg-gray-200 text-gray-700 font-semibold rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 border border-gray-500"
          >
            リセット
          </button>
        </div>
